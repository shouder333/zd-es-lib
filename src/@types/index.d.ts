...
type customView = Image & _Control & {
...
{
      addEventListener(eventName: 'move' | 'moving' | 'mousedown' | 'mouseup' | 'mousemove' | 'mouseover' | 'mouseout' | 'click', handler: (Event: MouseEvent) => unknown, capturePhase?: boolean): boolean;
      addEventListener(eventName: 'enterKey' | 'keydown' | 'keyup', handler: (Event: KeyboardEvent) => unknown, capturePhase?: boolean): boolean;
